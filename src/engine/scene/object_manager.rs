...
mod factory_tests {
    ...
    fn test_create_object_panics_when_exceeding_limit() {
        ...
        factory.create_object(create_test_components(), create_test_position(0, 0, 0, false));
        factory.create_object(create_test_components(), create_test_position(1, 1, 1, false));
        
        factory.create_object(create_test_components(), create_test_position(2, 2, 2, false));
    }
    ...
    fn test_create_object_reuses_freed_uid() {
        ...
        let (uid, _) = factory.create_object(create_test_components(), create_test_position(1, 1, 1, false));
    ...
    fn test_create_object_reuses_multiple_freed_uids() {
        ...
        let (uid1, _) = factory.create_object(create_test_components(), create_test_position(3, 3, 3, false));
        let (uid2, _) = factory.create_object(create_test_components(), create_test_position(4, 4, 4, false));
    ...
    fn test_create_object_with_freed_uids_at_limit() {
        ...
        let (uid, _) = factory.create_object(create_test_components(), create_test_position(2, 2, 2, false));
