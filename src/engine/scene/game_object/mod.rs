...
mod tests {
    ...
    #[test]
    fn test_new() {
        let position = Position { x: 10, y: 20, z: 30, is_relative: true };
        let components: Vec<Box<dyn Component>> = vec![
            Box::new(Sprite::new(None)),
        ];
    ...
    fn test_get_position() {
        let position = Position { x: 15, y: 25, z: 35, is_relative: false };
    ...
    fn test_update_position() {
        let mut game_object = create_test_game_object();
        let new_position = Position { x: 100, y: 200, z: 300, is_relative: false };
    ...
    fn test_new_empty_components_list() {
        let position = Position { x: 0, y: 0, z: 0, is_relative: true };
        let game_object = GameObject::new(vec![], position);
